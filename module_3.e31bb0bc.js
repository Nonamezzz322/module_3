...
function () {
  ...
  _createClass(UIController, [{
    key: "cardNumberValid",
    value: function cardNumberValid() {
      var _this = this;

      this.place = document.getElementById('place');
      this.name = document.getElementById('name');
      this.place.addEventListener('keyup', function () {
        if (_this.place.value.match(/^(\d{4}-){3}\d{4}/)) {
          _this.place.style.border = '2px solid green';
          _this.place.valid = true;
        } else {
          _this.place.style.border = '2px solid red';
          _this.place.valid = false;
        }

        _this.getButtonValid(_this.place, _this.name);
      });
    }
  }, {
    key: "nameValid",
    value: function nameValid() {
      ...
      this.name.addEventListener('keyup', function () {
        if (_this2.name.value.match(/^([A-z])+$/) && _this2.name.value.length >= 2) {
          _this2.name.style.border = '2px solid green';
          _this2.name.valid = true;
        } else {
          _this2.name.style.border = '2px solid red';
          _this2.name.valid = false;
        }

        _this2.getButtonValid(_this2.place, _this2.name);
      });
    }
  }, {
    key: "getButtonValid",
    value: function getButtonValid(place, name) {
    ...
    value: function hidePreloader() {
      ...
      var hidden = document.getElementById('preload');
    ...
    value: function createTable(data) {
      ...
      for (var i = 0; i < keys.length; i += 1) {
        ...
        keysTd.innerText = "".concat(keys[i]);
        tr.append(keysTd);
        ...
        if (values[i] === '') {
          ...
          valueTd.innerText = "".concat(values[i]);
        }
    ...
    value: function removeTable() {
      var elem = document.getElementsByClassName('tab')[0];
      var elem2 = document.getElementsByClassName('tab')[1];
...
var _ui_controller = _interopRequireDefault(require("./ui_controller.js"));
...
function () {
  ...
  _createClass(CardData, [{
    key: "takeApiData",
    value: function takeApiData() {
      var place = document.getElementById('place');
      return fetch("https://api.bincodes.com/cc/?format=json&api_key=d96ca493f5be297f8c304a87edcdf6a8&cc=".concat(place.value.replace(/-/g, ''))).then(function (res) {
        return res.json();
      });
    }
  }]);
...
},{"./ui_controller.js":"ui_controller.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var ui = new _ui_controller.default();
var data = new _card_data.default();
ui.cardNumberValid();
ui.nameValid();
ui.createPreloader();
var promise2 = new Promise(function (res, rej) {
  ...
  return ui.createTable(res);
}).then(function (res) {
  return ui.hidePreloader();
});
var request = document.getElementById('request');
var button = document.getElementById('clear');
...
request.addEventListener('click', function () {
  ...
  var promise1 = new Promise(function (res, rej) {
    ...
    return localStorage.setItem('table', res);
  }).then(function (res) {
    return localStorage.getItem('table', res);
  }).then(function (res) {
    return JSON.parse(res);
  }).then(function (res) {
    return ui.createTable(res);
...
},{"mask-input":"node_modules/mask-input/lib/maskInput.js","./ui_controller.js":"ui_controller.js","./card_data.js":"card_data.js"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
